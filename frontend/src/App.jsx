...
// Ofertas
import GestionOfertas from './pages/catalogo/OfertasAdmin.jsx'
import OfertasVigentes from './pages/catalogo/Ofertas.jsx'
...
function Shell() {
  ...
  return (
    <div
      className={`app ${sideOpen ? 'show-side' : ''} ${
        collapsed ? 'collapsed' : ''
      }`}
    >
      ...
      <div>
        ...
        <div className="container">
          <Routes>
            ...
            <Route path="/ofertas/vigentes" element={<OfertasVigentes />} />
            <Route path="/clientes" element={<Clientes />} />
            <Route path="/ventas" element={<Ventas />} />
            <Route
              path="/ventas/editar/:id"
              element={<Ventas isEditing={true} />}
            />
